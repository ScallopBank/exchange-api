...
- [Spot API Reference](#b5)
  - [open-api](#b6) ([Api Demo](https://github.com/scallop.exchange-doc/api/blob/master/demo/demo.txt))
...
Generate a string to be signed
    -   [open-api Demo](https://github.com/scallop.exchange-doc/api/blob/master/demo/demo.java)
